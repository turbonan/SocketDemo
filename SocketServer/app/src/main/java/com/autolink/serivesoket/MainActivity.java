package com.autolink.serivesoket;
...
import com.zhangli.serivesoket.R;
...
public class MainActivity extends AppCompatActivity  /*todo implements View.OnClickListener*/{
    ...
    private SocketServer server=new SocketServer (8090);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        A_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /**socket发送数据*/
                server.sendMessage ("Play_A_Media_Client");
            }
        });
        B_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /**socket发送数据*/
                server.sendMessage ("Play_B_Media_Client");
            }
        });
        C_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /**socket发送数据*/
                server.sendMessage ("Play_C_Media_Client");
            }
        });
        D_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /**socket发送数据*/
                server.sendMessage ("Play_D_Media_Client");
            }
        });
        /**socket收到消息线程*/
        SocketServer.ServerHandler=new Handler(  ){
            ...
            {
                stop();
                String maseeges = msg.obj.toString().substring(0, 19);
                get_text.setText (maseeges);
                Log.d("tag", maseeges);
                if(maseeges.equals("Play_A_Media_Server"))
                    path = "/storage/emulated/0/Download/vidio1.mp4";
                if(maseeges.equals("Play_B_Media_Server"))
                    path = "/storage/emulated/0/Download/vidio2.mp4";
                if(maseeges.equals("Play_C_Media_Server"))
                    path = "/storage/emulated/0/Download/vidio3.mp4";
                if(maseeges.equals("Play_D_Media_Server"))
